...
# probe for disk info ###############
clush $parg "echo 'Storage Controller: '; lspci | grep -i -e raid -e storage -e lsi"; echo $sep
...
clush $parg sysctl vm.swappiness net.ipv4.tcp_retries2 vm.overcommit_memory
...
case $distro in
   ...
   redhat|centos|red*)
      ...
      clush $parg "service iptables status | head -10"; echo $sep
